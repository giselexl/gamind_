...
import { collection, query, orderBy, getDocs, doc, getDoc, deleteDoc, updateDoc, arrayRemove } from 'firebase/firestore';
...
export default function ListDetailsScreen() {
  ...
  const copiarLink = async () => {
    ...
    Alert.alert("Link Copiado!", "O link da sua lista já está na área de transferência.");
  };
